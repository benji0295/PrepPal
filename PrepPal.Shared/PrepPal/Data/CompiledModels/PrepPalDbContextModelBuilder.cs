...
namespace PrepPal.Shared.PrepPal.Data.CompiledModels
{
    public partial class PrepPalDbContextModel
    {
        partial void Initialize()
        {
            ...
            var fridgeItem = FridgeItemEntityType.Create(this);
            var groceryItem = GroceryItemEntityType.Create(this);
            ...
            FridgeItemEntityType.CreateAnnotations(fridgeItem);
            GroceryItemEntityType.CreateAnnotations(groceryItem);
        ...
        private IRelationalModel CreateRelationalModel()
        {
            ...
            var fridgeItem = FindEntityType("PrepPal.Models.FridgeItem")!;

            var defaultTableMappings0 = new List<TableMappingBase<ColumnMappingBase>>();
            fridgeItem.SetRuntimeAnnotation("Relational:DefaultMappings", defaultTableMappings0);
            var prepPalModelsFridgeItemTableBase = new TableBase("PrepPal.Models.FridgeItem", null, relationalModel);
            var aisleColumnBase = new ColumnBase<ColumnMappingBase>("Aisle", "text", prepPalModelsFridgeItemTableBase);
            prepPalModelsFridgeItemTableBase.Columns.Add("Aisle", aisleColumnBase);
            var idColumnBase = new ColumnBase<ColumnMappingBase>("Id", "integer", prepPalModelsFridgeItemTableBase);
            prepPalModelsFridgeItemTableBase.Columns.Add("Id", idColumnBase);
            var isExpiredColumnBase = new ColumnBase<ColumnMappingBase>("IsExpired", "boolean", prepPalModelsFridgeItemTableBase);
            prepPalModelsFridgeItemTableBase.Columns.Add("IsExpired", isExpiredColumnBase);
            var isInGroceryListColumnBase = new ColumnBase<ColumnMappingBase>("IsInGroceryList", "boolean", prepPalModelsFridgeItemTableBase);
            prepPalModelsFridgeItemTableBase.Columns.Add("IsInGroceryList", isInGroceryListColumnBase);
            var isUsedColumnBase = new ColumnBase<ColumnMappingBase>("IsUsed", "boolean", prepPalModelsFridgeItemTableBase);
            prepPalModelsFridgeItemTableBase.Columns.Add("IsUsed", isUsedColumnBase);
            var lastBoughtDateColumnBase = new ColumnBase<ColumnMappingBase>("LastBoughtDate", "timestamp with time zone", prepPalModelsFridgeItemTableBase);
            prepPalModelsFridgeItemTableBase.Columns.Add("LastBoughtDate", lastBoughtDateColumnBase);
            var nameColumnBase = new ColumnBase<ColumnMappingBase>("Name", "text", prepPalModelsFridgeItemTableBase);
            prepPalModelsFridgeItemTableBase.Columns.Add("Name", nameColumnBase);
            var storageLocationColumnBase = new ColumnBase<ColumnMappingBase>("StorageLocation", "text", prepPalModelsFridgeItemTableBase);
            prepPalModelsFridgeItemTableBase.Columns.Add("StorageLocation", storageLocationColumnBase);
            relationalModel.DefaultTables.Add("PrepPal.Models.FridgeItem", prepPalModelsFridgeItemTableBase);
            var prepPalModelsFridgeItemMappingBase = new TableMappingBase<ColumnMappingBase>(fridgeItem, prepPalModelsFridgeItemTableBase, true);
            prepPalModelsFridgeItemTableBase.AddTypeMapping(prepPalModelsFridgeItemMappingBase, false);
            defaultTableMappings0.Add(prepPalModelsFridgeItemMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)idColumnBase, fridgeItem.FindProperty("Id")!, prepPalModelsFridgeItemMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)aisleColumnBase, fridgeItem.FindProperty("Aisle")!, prepPalModelsFridgeItemMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)isExpiredColumnBase, fridgeItem.FindProperty("IsExpired")!, prepPalModelsFridgeItemMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)isInGroceryListColumnBase, fridgeItem.FindProperty("IsInGroceryList")!, prepPalModelsFridgeItemMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)isUsedColumnBase, fridgeItem.FindProperty("IsUsed")!, prepPalModelsFridgeItemMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)lastBoughtDateColumnBase, fridgeItem.FindProperty("LastBoughtDate")!, prepPalModelsFridgeItemMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)nameColumnBase, fridgeItem.FindProperty("Name")!, prepPalModelsFridgeItemMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)storageLocationColumnBase, fridgeItem.FindProperty("StorageLocation")!, prepPalModelsFridgeItemMappingBase);

            var tableMappings0 = new List<TableMapping>();
            fridgeItem.SetRuntimeAnnotation("Relational:TableMappings", tableMappings0);
            var fridgeItemsTable = new Table("FridgeItems", null, relationalModel);
            var idColumn = new Column("Id", "integer", fridgeItemsTable);
            fridgeItemsTable.Columns.Add("Id", idColumn);
            idColumn.AddAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
            var aisleColumn = new Column("Aisle", "text", fridgeItemsTable);
            fridgeItemsTable.Columns.Add("Aisle", aisleColumn);
            var isExpiredColumn = new Column("IsExpired", "boolean", fridgeItemsTable);
            fridgeItemsTable.Columns.Add("IsExpired", isExpiredColumn);
            var isInGroceryListColumn = new Column("IsInGroceryList", "boolean", fridgeItemsTable);
            fridgeItemsTable.Columns.Add("IsInGroceryList", isInGroceryListColumn);
            var isUsedColumn = new Column("IsUsed", "boolean", fridgeItemsTable);
            fridgeItemsTable.Columns.Add("IsUsed", isUsedColumn);
            var lastBoughtDateColumn = new Column("LastBoughtDate", "timestamp with time zone", fridgeItemsTable);
            fridgeItemsTable.Columns.Add("LastBoughtDate", lastBoughtDateColumn);
            var nameColumn = new Column("Name", "text", fridgeItemsTable);
            fridgeItemsTable.Columns.Add("Name", nameColumn);
            var storageLocationColumn = new Column("StorageLocation", "text", fridgeItemsTable);
            fridgeItemsTable.Columns.Add("StorageLocation", storageLocationColumn);
            var pK_FridgeItems = new UniqueConstraint("PK_FridgeItems", fridgeItemsTable, new[] { idColumn });
            fridgeItemsTable.PrimaryKey = pK_FridgeItems;
            var pK_FridgeItemsUc = RelationalModel.GetKey(this,
                "PrepPal.Models.FridgeItem",
                new[] { "Id" });
            pK_FridgeItems.MappedKeys.Add(pK_FridgeItemsUc);
            RelationalModel.GetOrCreateUniqueConstraints(pK_FridgeItemsUc).Add(pK_FridgeItems);
            fridgeItemsTable.UniqueConstraints.Add("PK_FridgeItems", pK_FridgeItems);
            relationalModel.Tables.Add(("FridgeItems", null), fridgeItemsTable);
            var fridgeItemsTableMapping = new TableMapping(fridgeItem, fridgeItemsTable, true);
            fridgeItemsTable.AddTypeMapping(fridgeItemsTableMapping, false);
            tableMappings0.Add(fridgeItemsTableMapping);
            RelationalModel.CreateColumnMapping(idColumn, fridgeItem.FindProperty("Id")!, fridgeItemsTableMapping);
            RelationalModel.CreateColumnMapping(aisleColumn, fridgeItem.FindProperty("Aisle")!, fridgeItemsTableMapping);
            RelationalModel.CreateColumnMapping(isExpiredColumn, fridgeItem.FindProperty("IsExpired")!, fridgeItemsTableMapping);
            RelationalModel.CreateColumnMapping(isInGroceryListColumn, fridgeItem.FindProperty("IsInGroceryList")!, fridgeItemsTableMapping);
            RelationalModel.CreateColumnMapping(isUsedColumn, fridgeItem.FindProperty("IsUsed")!, fridgeItemsTableMapping);
            RelationalModel.CreateColumnMapping(lastBoughtDateColumn, fridgeItem.FindProperty("LastBoughtDate")!, fridgeItemsTableMapping);
            RelationalModel.CreateColumnMapping(nameColumn, fridgeItem.FindProperty("Name")!, fridgeItemsTableMapping);
            RelationalModel.CreateColumnMapping(storageLocationColumn, fridgeItem.FindProperty("StorageLocation")!, fridgeItemsTableMapping);

            var groceryItem = FindEntityType("PrepPal.Models.GroceryItem")!;

            var defaultTableMappings1 = new List<TableMappingBase<ColumnMappingBase>>();
            groceryItem.SetRuntimeAnnotation("Relational:DefaultMappings", defaultTableMappings1);
            var prepPalModelsGroceryItemTableBase = new TableBase("PrepPal.Models.GroceryItem", null, relationalModel);
            var aisleColumnBase0 = new ColumnBase<ColumnMappingBase>("Aisle", "text", prepPalModelsGroceryItemTableBase);
            prepPalModelsGroceryItemTableBase.Columns.Add("Aisle", aisleColumnBase0);
            var idColumnBase0 = new ColumnBase<ColumnMappingBase>("Id", "integer", prepPalModelsGroceryItemTableBase);
            prepPalModelsGroceryItemTableBase.Columns.Add("Id", idColumnBase0);
            var isBoughtColumnBase = new ColumnBase<ColumnMappingBase>("IsBought", "boolean", prepPalModelsGroceryItemTableBase);
            prepPalModelsGroceryItemTableBase.Columns.Add("IsBought", isBoughtColumnBase);
            var isInGroceryListColumnBase0 = new ColumnBase<ColumnMappingBase>("IsInGroceryList", "boolean", prepPalModelsGroceryItemTableBase);
            prepPalModelsGroceryItemTableBase.Columns.Add("IsInGroceryList", isInGroceryListColumnBase0);
            var lastBoughtDateColumnBase0 = new ColumnBase<ColumnMappingBase>("LastBoughtDate", "timestamp with time zone", prepPalModelsGroceryItemTableBase);
            prepPalModelsGroceryItemTableBase.Columns.Add("LastBoughtDate", lastBoughtDateColumnBase0);
            var nameColumnBase0 = new ColumnBase<ColumnMappingBase>("Name", "text", prepPalModelsGroceryItemTableBase);
            prepPalModelsGroceryItemTableBase.Columns.Add("Name", nameColumnBase0);
            var storageLocationColumnBase0 = new ColumnBase<ColumnMappingBase>("StorageLocation", "text", prepPalModelsGroceryItemTableBase);
            prepPalModelsGroceryItemTableBase.Columns.Add("StorageLocation", storageLocationColumnBase0);
            relationalModel.DefaultTables.Add("PrepPal.Models.GroceryItem", prepPalModelsGroceryItemTableBase);
            var prepPalModelsGroceryItemMappingBase = new TableMappingBase<ColumnMappingBase>(groceryItem, prepPalModelsGroceryItemTableBase, true);
            prepPalModelsGroceryItemTableBase.AddTypeMapping(prepPalModelsGroceryItemMappingBase, false);
            defaultTableMappings1.Add(prepPalModelsGroceryItemMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)idColumnBase0, groceryItem.FindProperty("Id")!, prepPalModelsGroceryItemMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)aisleColumnBase0, groceryItem.FindProperty("Aisle")!, prepPalModelsGroceryItemMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)isBoughtColumnBase, groceryItem.FindProperty("IsBought")!, prepPalModelsGroceryItemMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)isInGroceryListColumnBase0, groceryItem.FindProperty("IsInGroceryList")!, prepPalModelsGroceryItemMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)lastBoughtDateColumnBase0, groceryItem.FindProperty("LastBoughtDate")!, prepPalModelsGroceryItemMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)nameColumnBase0, groceryItem.FindProperty("Name")!, prepPalModelsGroceryItemMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)storageLocationColumnBase0, groceryItem.FindProperty("StorageLocation")!, prepPalModelsGroceryItemMappingBase);

            var tableMappings1 = new List<TableMapping>();
            groceryItem.SetRuntimeAnnotation("Relational:TableMappings", tableMappings1);
            var groceryItemsTable = new Table("GroceryItems", null, relationalModel);
            var idColumn0 = new Column("Id", "integer", groceryItemsTable);
            groceryItemsTable.Columns.Add("Id", idColumn0);
            idColumn0.AddAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
            var aisleColumn0 = new Column("Aisle", "text", groceryItemsTable);
            groceryItemsTable.Columns.Add("Aisle", aisleColumn0);
            var isBoughtColumn = new Column("IsBought", "boolean", groceryItemsTable);
            groceryItemsTable.Columns.Add("IsBought", isBoughtColumn);
            var isInGroceryListColumn0 = new Column("IsInGroceryList", "boolean", groceryItemsTable);
            groceryItemsTable.Columns.Add("IsInGroceryList", isInGroceryListColumn0);
            var lastBoughtDateColumn0 = new Column("LastBoughtDate", "timestamp with time zone", groceryItemsTable);
            groceryItemsTable.Columns.Add("LastBoughtDate", lastBoughtDateColumn0);
            var nameColumn0 = new Column("Name", "text", groceryItemsTable);
            groceryItemsTable.Columns.Add("Name", nameColumn0);
            var storageLocationColumn0 = new Column("StorageLocation", "text", groceryItemsTable);
            groceryItemsTable.Columns.Add("StorageLocation", storageLocationColumn0);
            var pK_GroceryItems = new UniqueConstraint("PK_GroceryItems", groceryItemsTable, new[] { idColumn0 });
            groceryItemsTable.PrimaryKey = pK_GroceryItems;
            var pK_GroceryItemsUc = RelationalModel.GetKey(this,
                "PrepPal.Models.GroceryItem",
                new[] { "Id" });
            pK_GroceryItems.MappedKeys.Add(pK_GroceryItemsUc);
            RelationalModel.GetOrCreateUniqueConstraints(pK_GroceryItemsUc).Add(pK_GroceryItems);
            groceryItemsTable.UniqueConstraints.Add("PK_GroceryItems", pK_GroceryItems);
            relationalModel.Tables.Add(("GroceryItems", null), groceryItemsTable);
            var groceryItemsTableMapping = new TableMapping(groceryItem, groceryItemsTable, true);
            groceryItemsTable.AddTypeMapping(groceryItemsTableMapping, false);
            tableMappings1.Add(groceryItemsTableMapping);
            RelationalModel.CreateColumnMapping(idColumn0, groceryItem.FindProperty("Id")!, groceryItemsTableMapping);
            RelationalModel.CreateColumnMapping(aisleColumn0, groceryItem.FindProperty("Aisle")!, groceryItemsTableMapping);
            RelationalModel.CreateColumnMapping(isBoughtColumn, groceryItem.FindProperty("IsBought")!, groceryItemsTableMapping);
            RelationalModel.CreateColumnMapping(isInGroceryListColumn0, groceryItem.FindProperty("IsInGroceryList")!, groceryItemsTableMapping);
            RelationalModel.CreateColumnMapping(lastBoughtDateColumn0, groceryItem.FindProperty("LastBoughtDate")!, groceryItemsTableMapping);
            RelationalModel.CreateColumnMapping(nameColumn0, groceryItem.FindProperty("Name")!, groceryItemsTableMapping);
            RelationalModel.CreateColumnMapping(storageLocationColumn0, groceryItem.FindProperty("StorageLocation")!, groceryItemsTableMapping);

            var ingredient = FindEntityType("PrepPal.Models.Ingredient")!;

            var defaultTableMappings2 = new List<TableMappingBase<ColumnMappingBase>>();
            ingredient.SetRuntimeAnnotation("Relational:DefaultMappings", defaultTableMappings2);
            var prepPalModelsIngredientTableBase = new TableBase("PrepPal.Models.Ingredient", null, relationalModel);
            var aisleColumnBase1 = new ColumnBase<ColumnMappingBase>("Aisle", "text", prepPalModelsIngredientTableBase);
            prepPalModelsIngredientTableBase.Columns.Add("Aisle", aisleColumnBase1);
            ...
            var nameColumnBase1 = new ColumnBase<ColumnMappingBase>("Name", "text", prepPalModelsIngredientTableBase);
            prepPalModelsIngredientTableBase.Columns.Add("Name", nameColumnBase1);
            var storageLocationColumnBase1 = new ColumnBase<ColumnMappingBase>("StorageLocation", "text", prepPalModelsIngredientTableBase);
            prepPalModelsIngredientTableBase.Columns.Add("StorageLocation", storageLocationColumnBase1);
            ...
            defaultTableMappings2.Add(prepPalModelsIngredientMappingBase);
            ...
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)aisleColumnBase1, ingredient.FindProperty("Aisle")!, prepPalModelsIngredientMappingBase);
            ...
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)nameColumnBase1, ingredient.FindProperty("Name")!, prepPalModelsIngredientMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)storageLocationColumnBase1, ingredient.FindProperty("StorageLocation")!, prepPalModelsIngredientMappingBase);

            var tableMappings2 = new List<TableMapping>();
            ingredient.SetRuntimeAnnotation("Relational:TableMappings", tableMappings2);
            ...
            var aisleColumn1 = new Column("Aisle", "text", ingredientsTable);
            ingredientsTable.Columns.Add("Aisle", aisleColumn1);
            ...
            var nameColumn1 = new Column("Name", "text", ingredientsTable);
            ingredientsTable.Columns.Add("Name", nameColumn1);
            var storageLocationColumn1 = new Column("StorageLocation", "text", ingredientsTable);
            ingredientsTable.Columns.Add("StorageLocation", storageLocationColumn1);
            ...
            tableMappings2.Add(ingredientsTableMapping);
            RelationalModel.CreateColumnMapping(ingredientIdColumn, ingredient.FindProperty("IngredientId")!, ingredientsTableMapping);
            RelationalModel.CreateColumnMapping(aisleColumn1, ingredient.FindProperty("Aisle")!, ingredientsTableMapping);
            RelationalModel.CreateColumnMapping(isSelectedColumn, ingredient.FindProperty("IsSelected")!, ingredientsTableMapping);
            RelationalModel.CreateColumnMapping(nameColumn1, ingredient.FindProperty("Name")!, ingredientsTableMapping);
            RelationalModel.CreateColumnMapping(storageLocationColumn1, ingredient.FindProperty("StorageLocation")!, ingredientsTableMapping);

            var instruction = FindEntityType("PrepPal.Models.Instruction")!;

            var defaultTableMappings3 = new List<TableMappingBase<ColumnMappingBase>>();
            instruction.SetRuntimeAnnotation("Relational:DefaultMappings", defaultTableMappings3);
            ...
            defaultTableMappings3.Add(prepPalModelsInstructionMappingBase);
            ...
            instruction.SetRuntimeAnnotation("Relational:TableMappings", tableMappings3);
            ...
            tableMappings3.Add(instructionsTableMapping);
            ...
            var nameColumnBase2 = new ColumnBase<ColumnMappingBase>("Name", "text", prepPalModelsRecipeTableBase);
            prepPalModelsRecipeTableBase.Columns.Add("Name", nameColumnBase2);
            ...
            defaultTableMappings4.Add(prepPalModelsRecipeMappingBase);
            ...
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)nameColumnBase2, recipe.FindProperty("Name")!, prepPalModelsRecipeMappingBase);
            ...
            var nameColumn2 = new Column("Name", "text", recipesTable);
            recipesTable.Columns.Add("Name", nameColumn2);
            ...
            RelationalModel.CreateColumnMapping(nameColumn2, recipe.FindProperty("Name")!, recipesTableMapping);
            ...
            recipeCategory.SetRuntimeAnnotation("Relational:DefaultMappings", defaultTableMappings5);
            ...
            defaultTableMappings5.Add(prepPalModelsRecipeCategoryMappingBase);
            ...
            recipeCategory.SetRuntimeAnnotation("Relational:TableMappings", tableMappings5);
            ...
            tableMappings5.Add(recipeCategoriesTableMapping);
            ...
            recipeIngredient.SetRuntimeAnnotation("Relational:DefaultMappings", defaultTableMappings6);
            var prepPalModelsRecipeIngredientTableBase = new TableBase("PrepPal.Models.RecipeIngredient", null, relationalModel);
            var aisleColumnBase2 = new ColumnBase<ColumnMappingBase>("Aisle", "text", prepPalModelsRecipeIngredientTableBase);
            prepPalModelsRecipeIngredientTableBase.Columns.Add("Aisle", aisleColumnBase2);
            ...
            var storageLocationColumnBase2 = new ColumnBase<ColumnMappingBase>("StorageLocation", "text", prepPalModelsRecipeIngredientTableBase);
            prepPalModelsRecipeIngredientTableBase.Columns.Add("StorageLocation", storageLocationColumnBase2);
            ...
            defaultTableMappings6.Add(prepPalModelsRecipeIngredientMappingBase);
            ...
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)aisleColumnBase2, recipeIngredient.FindProperty("Aisle")!, prepPalModelsRecipeIngredientMappingBase);
            ...
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)storageLocationColumnBase2, recipeIngredient.FindProperty("StorageLocation")!, prepPalModelsRecipeIngredientMappingBase);
            ...
            recipeIngredient.SetRuntimeAnnotation("Relational:TableMappings", tableMappings6);
            ...
            var aisleColumn2 = new Column("Aisle", "text", recipeIngredientsTable);
            recipeIngredientsTable.Columns.Add("Aisle", aisleColumn2);
            ...
            var storageLocationColumn2 = new Column("StorageLocation", "text", recipeIngredientsTable);
            recipeIngredientsTable.Columns.Add("StorageLocation", storageLocationColumn2);
            ...
            tableMappings6.Add(recipeIngredientsTableMapping);
            ...
            RelationalModel.CreateColumnMapping(aisleColumn2, recipeIngredient.FindProperty("Aisle")!, recipeIngredientsTableMapping);
            ...
            RelationalModel.CreateColumnMapping(storageLocationColumn2, recipeIngredient.FindProperty("StorageLocation")!, recipeIngredientsTableMapping);
            ...
            storageLocation.SetRuntimeAnnotation("Relational:DefaultMappings", defaultTableMappings7);
            ...
            defaultTableMappings7.Add(prepPalModelsStorageLocationMappingBase);
            ...
            storageLocation.SetRuntimeAnnotation("Relational:TableMappings", tableMappings7);
            ...
            tableMappings7.Add(storageLocationsTableMapping);
            ...
            unitOfMeasure.SetRuntimeAnnotation("Relational:DefaultMappings", defaultTableMappings8);
            ...
            defaultTableMappings8.Add(prepPalModelsUnitOfMeasureMappingBase);
            ...
            unitOfMeasure.SetRuntimeAnnotation("Relational:TableMappings", tableMappings8);
            ...
            tableMappings8.Add(unitsOfMeasureTableMapping);
